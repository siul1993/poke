        ...
        @foreach ($pokemon as $po)
          <div class="contenedor" >
            <div class="col-md-3 pokefondo" data-toggle="modal" data-target="#{{$po->id}}">
                <img  class="displayed" src="{{$po->imagen}}">
                <img  class="bot-fix" src="http://assets.pokemon.com/static2/_ui/img/chrome/notches/notch-collectibles-large.png">
                <?php
            ...
            <div class="modal-dialog modal-g" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body modal-b">
                  <div >
                    <img class="displayed" src="{{$po->imagen}}" alt="" />
                  </div>
                </div>
